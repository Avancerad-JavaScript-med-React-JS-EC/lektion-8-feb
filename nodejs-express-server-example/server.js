...
//Ifall ett request har url:en / så körs nedan kod
server.get('/', (request, response) => {
    console.log('Request från klient på url: ', request.url);

    fs.readFile('index.html', 'utf8', (error, content) => {
        //Skicka tillbaka ett svar till klienten med response.send()
        //Går bara att skicka ett response och det ska vara sist i denna funktion
